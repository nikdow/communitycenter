...
<div class="post_wrap clearfix">
	...
	<div class="shareModal_wrap">
			...
			<div id="shareModal-<?php the_ID(); ?>" class="reveal-modal tiny" data-reveal>
				...
				<a class="facebook" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php echo urlencode(the_permalink()) ?>','Facebook','width=600,height=300,left='+(screen.availWidth/2-300)+',top='+(screen.availHeight/2-150)+''); return false;" href="http://www.facebook.com/sharer.php?u=<?php the_permalink() ?>"><i class="fa fa-facebook-square"></i></a>
				...
				<a href="http://www.pinterest.com/pin/create/button/?url=<?php echo urlencode(the_permalink()) ?>&amp;description=<?php echo urlencode(get_the_title()) ?>"data-pin-do="buttonPin"data-pin-config="above"><i class="fa fa-pinterest-square"></i></a>
